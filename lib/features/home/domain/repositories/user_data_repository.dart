...
abstract class UserDataRepository {
  ...
  Future<Either<Failure, void>> updateUserSalary(String userId, double salary);
  ...
  Future<Either<Failure, void>> updateExpense(String userId, String category, double amount, String dueDate);
  Future<Either<Failure, void>> deleteExpense(String userId, String category);
} 